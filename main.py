...
def main():
    ...
    with tab1:
        ...
        if mode == "Snapshot Mode (Stability AI)":
            ...
            if st.button("Generate Video"):
                if not prompt:
                    ...
                    return
                # Implement snapshot mode logic using snapshot_mode_v2
                try:
                    video_clips = snapshot_mode_v2(stability_api_key, prompt, num_segments, cfg_scale, motion_bucket_id, seed)
                    if video_clips:
